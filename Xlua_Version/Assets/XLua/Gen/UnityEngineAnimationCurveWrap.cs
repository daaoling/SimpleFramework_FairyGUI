...
namespace CSObjectWrap
{
    public class UnityEngineAnimationCurveWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "Evaluate", Evaluate);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "AddKey", AddKey);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "MoveKey", MoveKey);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "RemoveKey", RemoveKey);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SmoothTangents", SmoothTangents);
			
			
			Utils.RegisterFunc(L, Utils.GETTER_IDX, "keys", get_keys);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "length", get_length);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "preWrapMode", get_preWrapMode);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "postWrapMode", get_postWrapMode);
            
			Utils.RegisterFunc(L, Utils.SETTER_IDX, "keys", set_keys);
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "preWrapMode", set_preWrapMode);
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "postWrapMode", set_postWrapMode);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "Linear", Linear_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "EaseInOut", EaseInOut_xlua_st_);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int AddKey(RealStatePtr L)
        {
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int Linear_xlua_st_(RealStatePtr L)
        {
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int EaseInOut_xlua_st_(RealStatePtr L)
        {
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int get_keys(RealStatePtr L)
        {
            ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
            try {
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int get_preWrapMode(RealStatePtr L)
        {
            ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
            try {
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int get_postWrapMode(RealStatePtr L)
        {
            ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
            try {
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int set_keys(RealStatePtr L)
        {
            ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
            try {
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int set_preWrapMode(RealStatePtr L)
        {
            ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
            try {
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int set_postWrapMode(RealStatePtr L)
        {
            ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
            try {
