...
namespace CSObjectWrap
{
    public class SystemObjectWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetType", GetType);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "Equals", Equals_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "ReferenceEquals", ReferenceEquals_xlua_st_);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int Equals_xlua_st_(RealStatePtr L)
        {
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int GetType(RealStatePtr L)
        {
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int ReferenceEquals_xlua_st_(RealStatePtr L)
        {
