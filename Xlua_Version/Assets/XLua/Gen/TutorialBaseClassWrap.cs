...
namespace CSObjectWrap
{
    public class TutorialBaseClassWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "BMFunc", BMFunc);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetSomeBaseData", GetSomeBaseData);
			
			
			Utils.RegisterFunc(L, Utils.GETTER_IDX, "BMF", get_BMF);
            
			Utils.RegisterFunc(L, Utils.SETTER_IDX, "BMF", set_BMF);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "BSFunc", BSFunc_xlua_st_);
            
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(Tutorial.BaseClass));
			Utils.RegisterFunc(L, Utils.CLS_GETTER_IDX, "BSF", get_BSF);
            
			Utils.RegisterFunc(L, Utils.CLS_SETTER_IDX, "BSF", set_BSF);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int BSFunc_xlua_st_(RealStatePtr L)
        {
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int BMFunc(RealStatePtr L)
        {
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int GetSomeBaseData(RealStatePtr L)
        {
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int get_BMF(RealStatePtr L)
        {
            ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
            try {
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int get_BSF(RealStatePtr L)
        {
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int set_BMF(RealStatePtr L)
        {
            ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
            try {
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int set_BSF(RealStatePtr L)
        {
