...
public class Packager {
    ...
    static void HandleBundle() {
        ...
        ///把lua文件根据目录进行ab打包
        ///Assets
        ///       LuaFramework\Lua\Logic\*.lua 
        /// =>    StreamingAssets\Lua\Logic\*.lua.bytes
        /// =>    StreamingAssets\lua\lua_logic.unity3d
        BuildLuaBundles();

        ///把一些不是lua 比如json pb 拷贝过去
        ///       Lua\3rd\cjson\*.json
        ///       StreamingAssets\lua\3rd\cjson\*.json
        ...
        for (int i = 0; i < luaPaths.Length; i++) {
            ...
            foreach (string f in files) {
                ...
                //UnityEngine.Debug.Log(" init " + f + " now " + destfile);
