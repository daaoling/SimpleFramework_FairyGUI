...
#pragma warning restore 0414
	...
	{
#if LOG_ALL_MESSAGES
		Debugger.Log("MESSENGER Cleanup. Make sure that none of necessary listeners are removed.");
#endif
	...
	#region AddListener
    static public void AddListener(int eventType, Callback handler) { AddListener(eventType.ToString(), handler); }
	//No parameters
    ...
    static public void RemoveListener(int eventType, Callback handler) { RemoveListener(eventType.ToString(), handler); }
	//No parameters
	...
	#region Broadcast
    static public void Broadcast(int eventType) { Broadcast(eventType.ToString());}
	//No parameters
    static public void Broadcast(string eventType) {
#if LOG_ALL_MESSAGES || LOG_BROADCAST_MESSAGE
		Debugger.Log("MESSENGER\t" + System.DateTime.Now.ToString("hh:mm:ss.fff") + "\t\t\tInvoking \t\"" + eventType + "\"");
#endif
